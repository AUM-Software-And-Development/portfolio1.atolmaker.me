...
function BuildFromIndex() {
    ...
    if (Input === true) {
        InputInstruction.push(document.getElementById("UserInput").value);
        LanguageMap();
        UserInputSwitch = 0;
    }
}
...
function Parser() {
    ...
    do {
        ...
        if (Switch === 1) {
            ...
            if (Case === 17) {
                var PostToIndex = "/?JSInput="; /* View History */
                PostToIndex += "5";
                UserLocation = 5;
                PostToIndex += "&JSString=";
                PostToIndex += InputInstruction;
        ...
        if (Switch === 2) {
            ...
            if (Case === 1) { document.body.style.backgroundColor = "Red"; Case = 0; Switch = 0; document.getElementById("UserInput").focus(); break; }
...
function MakeActive(Index) {
    ...
    if (Index === 5) { document.getElementById('a5').classList.add("Active"); }
...
function DisplayArticles(Index) {
    ...
    if (Index === 1) {
        ...
        document.getElementById('LanguageDev3').style.display = "block";
    }
    if (Index === 2) {
    ...
    if (Index === 3) {
        ...
        document.getElementById('LanguageDev3').style.display = "none";
    }
    if (Index === 4) {
        document.getElementById('Synth1').style.display = "block";
        document.getElementById('Synth2').style.display = "block";
